// ============================================================
// SFMS LITE — Edge Function: midtrans-webhook
// Endpoint yang dipanggil OLEH Midtrans (bukan oleh frontend kita)
// setiap kali status transaksi berubah. Verifikasi signature wajib
// dilakukan supaya tidak ada pihak lain bisa memalsukan notifikasi
// "pembayaran berhasil".
// ============================================================
